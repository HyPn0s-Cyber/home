...
![Picture of the challenge's rules](/assets/img/Curse-Pharaoh-3.png)
...
When lauching the game, you arrive in front of a pyramid, a guard is there asking for 10 000$ but unfortunately, you have just 5 bucks. Harsh.

![Picture of the guard asking for a 10000$ bribe](/assets/img/guard.png)
...
![Picture of the Cheat Engine Tool with only one variable left](/assets/img/Cheat-Engine.png)
...
![Picture of the flag written inside the pyramid](/assets/img/flag_Curse_Pharaoh3.png)
